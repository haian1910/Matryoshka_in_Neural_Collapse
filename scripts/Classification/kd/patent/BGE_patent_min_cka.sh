...
TEACHER_MODEL_PATH="/xxx/Dynamic_mapping_Distillation/outputs/LLM2Vec/sft/patent/criterion=cross_entropy__lora-rank=16-alpha=32-dropout=0.1-bf16__epoch=2__bsz=8x1x8=64__lr=0.00001/epoch2_step782_loss0.1096" # GẮN LINK MODEL CHECKPOINT VÀO ĐÂY
# data
DATASET=patent
