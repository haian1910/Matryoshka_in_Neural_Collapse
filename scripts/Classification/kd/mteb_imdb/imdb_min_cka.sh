...
TEACHER_MODEL_PATH="/xxx/Dynamic_mapping_Distillation/outputs/LLM2Vec/sft/imdb/criterion=cross_entropy__lora-rank=256-alpha=16-dropout=0.1-bf16__epoch=10__bsz=8x1x8=64__lr=0.00001/epoch10_step3910_loss0.0298" # GẮN LINK MODEL CHECKPOINT VÀO ĐÂY
# data
DATASET=imdb
